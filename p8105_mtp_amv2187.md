...
![](p8105_mtp_amv2187_files/figure-markdown_github/unnamed-chunk-5-1.png)
...
![](p8105_mtp_amv2187_files/figure-markdown_github/unnamed-chunk-6-1.png)

``` r
agg_hour %>%
  mutate(day_over_time = ceiling(order/24)) %>%
...
![](p8105_mtp_amv2187_files/figure-markdown_github/unnamed-chunk-6-2.png)
