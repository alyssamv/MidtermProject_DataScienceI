...
The dataset is comprised of information collected every minute over 47 weeks (329 days). The resulting dataset is the quite large, with `r nrow(accel_data)` recorded minutes, grouped by week and day of the week. 
